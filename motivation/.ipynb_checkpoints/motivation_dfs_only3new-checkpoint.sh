...
APP_DIR="../application"     # workloads: application/<name>.cu
SCHED_DIR="../Scheduler"     # controller.cc + scheduler.py
LOG_ROOT="./DFS"         # logs under *current* experiment folder

combinations=(
  "mm bfs_converted histogram_converted"
)
#default_rates=(0.0050 0.0050)
default_rates=(0.0500 0.0500 0.0800)
#default_rates=(0.0300 0.01500)
duration=250
solution=2
setpoint_combos=(
  "0.90 0.90 0.90"
...
compile_server() {
  ...
  g++ "$src" -o server -std=c++17 -lrt -pthread -DCLAMP_PERIODS -DBOUND=20
