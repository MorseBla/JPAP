...
if __name__=='__main__':
    ...
    if int(sys.argv[1]) == 4:
        ...
        with open('logs/task_values.txt', 'w') as file:
            ...
            file.write(f"{t3}\n")
        file.close
        command1=["./"+str(t1),str(0),sys.argv[6],sys.argv[7] ,sys.argv[14], "logs/task1", str(0)]
        command2=["./"+str(t2),str(1),sys.argv[8],sys.argv[9],sys.argv[14], "logs/task2", str(0)]
        command3=["./"+str(t3),str(2),sys.argv[10],sys.argv[11],sys.argv[14], "logs/task3", str(0)]
        ...
        solution = "1"      # 1=FC_GPU, 3=LQR/Proposed, 7=DFS
        power_sp = "5000"
                ...
                if process.poll() is not None:
                    ...
                    if(elapsed_time>=0.5*timeout and switch==0):
                        ...
                        with open('logs/task_values.txt', 'w') as file:
                            ...
                            file.write(f"{t4}\n")
                        file.close
                        command5=["./"+str(t4),str(3),sys.argv[10],sys.argv[11],sys.argv[14], "logs/task4", str(0)]
                        print(command5)
